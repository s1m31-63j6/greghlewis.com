...
export const FORMATIONS: Formation[] = [
  ...
  F({
    id: "flag-divide",
    name: "Divide",
    aliases: ["Flag Divide", "Split Wide"],
    strength: "R",
    qb: { align: "gun", depthYd: -4.0 },
    backs: [],
    receivers: [
      { slot: "Z", side: "R", order: 1, split: "wide", onLine: false, priority: 1 },
      { slot: "X", side: "L", order: 1, split: "wide", onLine: false, priority: 2 },
      { slot: "Y", side: "R", order: 2, split: "tight", onLine: false, depthYd: -1.6, priority: 3 },
    ],
    tags: ["flag", "divide", "2x1", "wing", "red-zone"],
    variantScope: ["5flag"],
  }),
  F({
    id: "flag-split-backs",
    name: "Split Backs",
    aliases: ["Flag Split Backs", "Two Back"],
    strength: "R",
    qb: { align: "gun", depthYd: -4.0 },
    backs: [
      { slot: "RB", align: "split", side: "R", depthYd: -5.0, priority: 2 },
      { slot: "FB", align: "split", side: "L", depthYd: -5.0, priority: 3 },
    ],
    receivers: [{ slot: "Z", side: "R", order: 1, split: "wide", onLine: false, priority: 1 }],
    tags: ["flag", "split-backs", "screen", "protection"],
    variantScope: ["5flag"],
  }),
  F({
    id: "gun-empty-quads",
    name: "Gun Empty Quads",
    aliases: ["Quads Empty", "Empty Four Strong"],
    personnelId: "10",
    strength: "R",
    qb: { align: "gun", depthYd: -5.0 },
    backs: [],
    receivers: [
      { slot: "Z", side: "R", order: 1, split: "wide", onLine: true, priority: 1 },
      { slot: "H", side: "R", order: 2, split: "plus", onLine: false, priority: 2 },
      { slot: "Y", side: "R", order: 3, split: "slot", onLine: false, priority: 3 },
      { slot: "F", side: "R", order: 4, split: "nasty", onLine: false, priority: 4 },
      { slot: "X", side: "L", order: 1, split: "wide", onLine: true, priority: 5 },
    ],
    tags: ["shotgun", "empty", "quads", "overload", "no-back"],
    variantScope: ["11man", "7man"],
  }),
  F({
    id: "pistol-diamond",
    name: "Pistol Diamond",
    aliases: ["Diamond", "Bone Pistol", "Three Back Pistol"],
    personnelId: "21",
    strength: "R",
    qb: { align: "pistol", depthYd: -4.0 },
    backs: [
      { slot: "RB", align: "i", side: "mid", depthYd: -7.0, priority: 1 },
      { slot: "A1", align: "split", side: "R", depthYd: -5.0, priority: 2 },
      { slot: "A2", align: "split", side: "L", depthYd: -5.0, priority: 3 },
    ],
    receivers: [
      { slot: "Z", side: "R", order: 1, split: "wide", onLine: true, priority: 4 },
      { slot: "X", side: "L", order: 1, split: "wide", onLine: true, priority: 5 },
    ],
    tags: ["pistol", "diamond", "three-back", "option", "run-heavy"],
    variantScope: ["11man"],
  }),
  F({
    id: "i-twins-right",
    name: "I Twins Right",
    aliases: ["I Twins", "Twin I"],
    personnelId: "21",
    strength: "R",
    qb: { align: "under" },
    backs: [
      { slot: "FB", align: "i", side: "mid", depthYd: -4.2, priority: 2 },
      { slot: "RB", align: "i", side: "mid", depthYd: -6.6, priority: 1 },
    ],
    receivers: [
      { slot: "Z", side: "R", order: 1, split: "wide", onLine: true, priority: 3 },
      { slot: "H", side: "R", order: 2, split: "slot", onLine: false, priority: 4 },
      { slot: "X", side: "L", order: 1, split: "wide", onLine: true, priority: 5 },
    ],
    tags: ["under-center", "i-formation", "twins", "play-action"],
    variantScope: ["11man", "9man"],
  }),
  F({
    id: "double-wing-right",
    name: "Double Wing",
    aliases: ["Double Wing", "Tight Double Wing"],
    personnelId: "22",
    strength: "R",
    qb: { align: "under" },
    backs: [
      { slot: "FB", align: "i", side: "mid", depthYd: -3.8, priority: 1 },
      { slot: "A1", align: "wing", side: "R", priority: 2 },
      { slot: "A2", align: "wing", side: "L", priority: 3 },
    ],
    receivers: [
    ...
    tags: ["under-center", "double-wing", "wing-t", "condensed", "short-yardage"],
    variantScope: ["11man", "9man", "8man"],
  }),
  F({
    id: "unbalanced-heavy-right",
    name: "Unbalanced Heavy",
    aliases: ["Tackle Over", "Unbalanced", "Heavy Right"],
    personnelId: "13",
    strength: "R",
    qb: { align: "under" },
    backs: [{ slot: "RB", align: "i", side: "mid", depthYd: -6.0, priority: 1 }],
    receivers: [
      { slot: "Y", side: "R", order: 2, split: "attached", onLine: true, priority: 2 },
      { slot: "V", side: "R", order: 3, split: "tight", onLine: true, priority: 3 },
      { slot: "H", side: "R", order: 1, split: "wing", onLine: false, priority: 4 },
      { slot: "X", side: "L", order: 1, split: "plus", onLine: true, priority: 5 },
    ],
    tags: ["under-center", "unbalanced", "heavy", "short-yardage", "formation-stress"],
    variantScope: ["11man", "9man"],
  }),
  F({
    id: "gun-nub-trips",
    name: "Gun Nub Trips",
    aliases: ["Nub Trips", "Trips Nub", "Solo Tight End"],
    personnelId: "11",
    strength: "R",
    qb: { align: "gun", depthYd: -5.0 },
    backs: [{ slot: "RB", align: "offset", side: "R", depthYd: -5.0, priority: 2 }],
    receivers: [
      { slot: "Z", side: "L", order: 1, split: "wide", onLine: true, priority: 1 },
      { slot: "H", side: "L", order: 2, split: "plus", onLine: false, priority: 3 },
      { slot: "X", side: "L", order: 3, split: "slot", onLine: false, priority: 4 },
      { slot: "Y", side: "R", order: 1, split: "attached", onLine: true, priority: 5 },
    ],
    tags: ["shotgun", "trips", "nub", "boundary-tight-end", "run-strength"],
    variantScope: ["11man", "7man"],
  }),
];
